<footer class="footer">
    <div class="w-100 clearfix">
        <span class="text-center text-sm-left d-md-inline-block">
            Copyright © <?=date("Y")?>
            <a href="https://247.ourtechnologies.org" class="text-blue" target="_blank">Our Technologies</a>
            All Rights Reserved.
        </span>
...
<script>
  ...
  setTimeout(()=>{
      ...
      console.warn("Do not copy / paste any code here..\n" +
          ...
          "You might end up exposing your data hence your data will be at risk." +
