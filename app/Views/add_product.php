                        ...
                        <div class="col-lg-4">
                            <nav class="breadcrumb-container" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/products">Products</a>
                                    </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required id="productname" name="productname"
                                           placeholder="eg. Coke - 300ml">
                                </div>
                                <div class="form-group">
                                    <label for="specs">Specification</label>
                                    <textarea class="form-control" id="specs" name="description"
                                              placeholder="zero sugar, 300ml, "></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="sellingprice">Selling Price</label>
                                    <input type="number" step="0.01" class="form-control" required id="sellingprice"
                                           name="sellingprice" placeholder="Selling Price">
                                </div>
                                <div class="form-group">
                                    <label for="costprice">Cost Price</label>
                                    <input type="number" step="0.01" class="form-control" required id="costprice"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled id="imagename"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" value="0" id="quantity"
                                           name="quantity">
                                </div>
                                <div class="form-group">
                                    <label for="refill">Refill Alert Level</label>
                                    <input type="number" step="0.01" class="form-control" value="0" id="refill"
                                           name="refill">
                                </div>
                                <div class="form-group">
                                    ...
                                    <span>
                                                    <input hidden type="text" id="status_txt" name="product_status"
                                                           class="form-control" readonly value="active">
                                                </span>
                                </div>
                                <div class="form-group">
                                    <label for="barcode_no">Barcode</label>
                                    <input type="text" class="form-control" id="barcode_no" name="barcode_no"
                                           placeholder="eg. 8404613064946">
                                </div>
