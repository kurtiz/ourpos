                        ...
                        <div class="col-lg-4">
                            <nav class="breadcrumb-container" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?= base_url()?>/store" loading="true">Store</a>
                                    </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                <b>Invoice No.: </b><?=$sale->invoice_num?><br>
                                <b>Order ID:</b> 4F3S8J<br>
                                <b>Payment Due: </b> <?=$sale->date_sold?><br>
                                <b>Sales Rep :</b>
                                <a loading="true" href="<?=base_url()?>/users/view/<?=$userdata->user_id?>" style="color: #0f38ff">
                                    <?=$userdata->name?>
                                </a>
                            </div>
                        </div>
...
<!--                                            <td>--><?//=$saleDetails[$i]['cat_name']?><!--</td>-->
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a loading="true" href="<?=base_url()?>/store/print/credit/<?=$sale->sales_id?>" id="printBtn" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i>Print</a>
                                <a loading="true" href="<?=base_url()?>/store" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fas fa-store"></i>Go To Store Front</a>
                            </div>
                        </div>
                    </div>
                </div>
