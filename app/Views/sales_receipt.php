                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <?php if ($sale['pending_status'] == 1):?>
                                    <a href="<?=base_url()?>/store/sales/edit/<?=$saleID?>" id="editBtn" class="btn btn-success pull-right"><i class="fa fa-edit"></i>Edit</a>
                                <?php else:?>
                                    <a href="<?=base_url()?>/store/print/receipt/<?=$saleID?>" id="printBtn" class="btn btn-success pull-right"><i class="fa fa-print"></i>Print</a>
                                <?php endif;?>
