                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Credit Sales</h5>
                                    <span>All credit sales made are listed here</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <nav class="breadcrumb-container" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/store">Store</a></li>
                                                ...
                                                <tr id="sale<?=$row["sales_id"]?>">
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="<?= base_url(); ?>/store/credit_sales/view/<?= $row['sales_id'] ?>"><i
                                                            ...
                                                            <?php if (isset($user_role_permissions)):?>
                                                                <?php if ($user_role_permissions[7]['state'] == "true"):?>
...
<script>
    ...
    function edit(id){
        ...
        Swal.fire({
            title: 'Are you sure you want to edit this credit sale?',
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                window.location.assign(domain + "/store/credit_sales/edit/"+id)
    ...
    function sendPrint(id){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                loading_overlay(1)
                // redirects to the edit page
                window.location.assign(domain + "/store/print/credit/"+id)
            } else if (result.isDenied) { // when the denied button (no) is clicked
                // Denial message pop up
    ...
    function delete_sale(id) {
        let domain = $("#domain").prop("href");
        url = (domain + "/store/credit_sales/delete/" + id);
        console.log(domain)
        console.log(url)
        //  Shows Pop Up to confirm edit event
        Swal.fire({
            title: 'Are you sure you want to delete this credit sales record?',
            showDenyButton: true,
            showCancelButton: true,
            confirmButtonText: `Yes`,
            denyButtonText: `No`,
