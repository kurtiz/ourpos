                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Add User</h5>
                                    <span>Add users to your store</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <nav class="breadcrumb-container" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/users">Users</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?=form_open_multipart(base_url()."/users/add",['id'=>"user-form", 'class'=>"forms-sample"])?>
                                <div class="form-group">
                                    <label for="usersname">Name</label>
                                    <input type="text" class="form-control" required id="usersname" name="usersname" placeholder="eg. Jonas Antwi">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="cusemail">Username</label>
                                    <input type="text" class="form-control" id="cususername" name="cususername" required placeholder="eg. joel_34">
                                    <div style="padding-left: 10px; font-size: 10px" id="username_error"></div>
                                </div>
                                <div class="form-group">
                                    <label for="cusrole">Role</label>
                                    <select id="cusrole" name="cusrole" class="form-control select2">
