                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Add Category</h5>
                                            <span>Add categories to your inventory for easy sorting</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?=form_open_multipart(base_url()."/products/savecategory",['id'=>"item-form", 'class'=>"forms-sample"])?>
                                            <div class="form-group">
                                                <label for="catname">Name</label>
                                                <input type="text" class="form-control" required id="catname" name="catname" placeholder="eg. Coke - 300ml">
                                            </div>
                                            <div class="form-group">
                                                <label for="description">Description</label>
                                                <textarea class="form-control" id="description" name="description" placeholder="zero sugar, 300ml, "></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="default-value">Color</label>
                                                <input type="text" id="default-value" class="form-control col-sm-12" name="color"  value="#ff6600">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label>Image</label>
                                                <input type="file" name="img" id="imgupload" class="file-upload-default">
